...
import json
import os
client = OpenAI(api_key='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')

# Set your OpenAI API key (replace 'your-api-key' with your actual key)

# Function to extraction text from PDF
...
# Function to extract "Experience" section using the new OpenAI ChatCompletion API
def extract_experience_section(text):
    ...
    response = client.chat.completions.create(model="gpt-4-turbo",  # or "gpt-4" if you have access
    messages=messages,
    temperature=0.3,
    max_tokens=1500,
    n=1)
...
# Full workflow combining both PDF extraction and AI processing
def main(pdf_directory, output_json_path):
    ...
    for pdf_filename in os.listdir(pdf_directory):
        if pdf_filename.endswith(".pdf"):
            ...
            # Format and add to the result dictionary
            try:
...
pdf_directory = "cv_30"  # Replace with the path to your directory of PDF files
